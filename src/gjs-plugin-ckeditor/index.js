// Init ckeditor as global method
import 'ckeditor';
...
export default function(editor, opts = {}) {
  ...
  var lacationHref = window.location.href;
  var ckeditorHref = `${lacationHref}node_modules/ckeditor/`;

  CKEDITOR.basePath = ckeditorHref;

  for (var key in CKEDITOR.plugins.registered) {
    CKEDITOR.plugins.registered[key].path = CKEDITOR.plugins.registered[
      key
    ].path.replace(lacationHref, ckeditorHref);
  }
